...
class IndentLines(BaseAiderTool):
    """
    ...
    def get_tool_definition(self):
        return {
            ...
            "function": {
                "name": "IndentLines",
                "description": "Indent or unindent a block of lines in a file.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "file_path": {
                        ...
                        "start_pattern": {
                            "type": "string",
                            "description": (
                                "Pattern marking the start of the block to indent (line containing"
                                " this pattern)."
                            ),
                        },
                        "end_pattern": {
                            "type": "string",
                            "description": (
                                "Optional pattern marking the end of the block (line containing"
                                " this pattern)."
                            ),
                        },
                        "line_count": {
                            "type": "integer",
                            "description": (
                                "Optional number of lines to indent (alternative to end_pattern)."
                            ),
                        },
                        "indent_levels": {
                            "type": "integer",
                            "description": (
                                "Number of levels to indent (positive) or unindent (negative)."
                            ),
                            "default": 1,
                        },
                        "near_context": {
    ...
    def run(
        ...
        try:
            ...
            if original_content == new_content:
                self.coder.io.tool_warning("No changes made: indentation would not change file")
