...
Start working with cecli and xAI on your codebase:
...
# Grok 3
cecli --model xai/grok-3-beta

# Grok 3 fast (faster, more expensive)
cecli --model xai/grok-3-fast-beta

# Grok 3 Mini
cecli --model xai/grok-3-mini-beta

# Grok 3 Mini fast (faster, more expensive)
cecli --model xai/grok-3-mini-fast-beta
