...
- Launch cecli with image filenames on the command line: `cecli <image-filename>` along with any other command line arguments you need.
...
- Use `/web <url>`
- Just paste the URL into the chat and cecli will ask if you want to add it.

You can also scrape web pages from the command line to see the markdown version that cecli produces:


```
python -m cecli.scrape https://cecli.dev/docs/usage/tips.html
```
